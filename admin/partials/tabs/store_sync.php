            ...
            <div class="sqm-mc-woocommerce-last-sync">
                ...
                <p>
                    ...
                    <i id="squalomail_last_updated">
                        ...
                        <?php else : ?>
                        <?php esc_html_e('Starting...', 'squalomail-for-woocommerce'); ?>
                        <?php endif;?>
                    </i>
            ...
            <fieldset>    
                <p>
                    <span>Messaging is currently
                        <span class="comm_box_status <?= $comm_enabled === '0' ? 'hidden' : '';?>" id="comm_box_status_1" <?php if($comm_enabled === '0') echo ' class="hidden" '; ?> > <?php esc_html_e('enabled', 'squalomail-for-woocommerce');?></span>
                        <span class="comm_box_status <?= $comm_enabled === '1' ? 'hidden' : '';?>" id="comm_box_status_0" <?php if($comm_enabled === '1') echo ' class="hidden" '; ?>> <?php esc_html_e('disabled', 'squalomail-for-woocommerce');?></span>
                    </span>
...
<div class="sync-content-wrapper sync-more-wrapper">
    <div class="box box-half">
        <div class="content">
            <h3 style="padding-top: 1em;"><?php esc_html_e('Synchronization', 'squalomail-for-woocommerce');?></h3>
            <p id="resync_data_help_text">
                <?php esc_html_e('You can resync your audience at any time without losing any of your e-commerce data.', 'squalomail-for-woocommerce');?>
            </p>
            <?php if ($show_resync) : ?>
                <?php submit_button(__('Resync now', 'squalomail-for-woocommerce'), 'primary sqm-mc-woocommerce-resync-button','submit', TRUE); ?>
            <?php else : ?>
                <?php submit_button(__('Resync now', 'squalomail-for-woocommerce'), 'sqm-mc-woocommerce-resync-button','submit', TRUE, ['disabled' => true]); ?>
                <p class="description"><?php _e('Sync is running. Please wait until it finishes.', 'squalomail-for-woocommerce') ?></p>
            <?php endif;?>
        </div>
    </div>
    ...
    <div class="box box-half">
        <div class="content">
            <h3 style="padding-top: 1em;"><?php esc_html_e('More Information', 'squalomail-for-woocommerce'); ?></h3>
            <ul>
                <li><?= sprintf(/* translators: %s - Plugin review URL. */wp_kses( __( 'Is this plugin helping your e-commerce business? <a href=%s target=_blank>Please leave us a ★★★★★ review!</a>.', 'squalomail-for-woocommerce' ), array(  'a' => array( 'href' => array(), 'target'=> '_blank' ) ) ), esc_url( 'https://wordpress.org/support/plugin/mailchimp-for-woocommerce/reviews/' ) );?></li>
                <li><?= sprintf(/* translators: %s - WP-CLI URL. */wp_kses( __( 'Have a larger store or having issues syncing? Consider using <a href=%s target=_blank>WP-CLI</a> or browse documentation around common <a href=%s target=_blank>caching problems</a>.', 'squalomail-for-woocommerce' ), array(  'a' => array( 'href' => array(), 'target'=> '_blank' ) ) ), esc_url( 'https://github.com/mailchimp/mc-woocommerce/wiki/Advanced-Queue-Setup-In-CLI-mode' ), esc_url( 'https://github.com/mailchimp/mc-woocommerce/wiki/Using-Caches' ) );?></li>
...
<div id="sqm-mc-woocommerce-support-form" class="sqm-mc-woocommerce-modal">
    <div id="exampleModal" class="reveal-modal">
        ...
        <div class="modal-header">
            ...
            <h3><?= __('Send us a support ticket', 'squalomail-for-woocommerce');?></h3>
            <p class="description support-form"><?= __('The best way to get in touch with us is by submitting a ticket in the form below. </br> We do our best to get back to you within 48 hours. We look forward to hear from you!', 'squalomail-for-woocommerce');?></p>
            ...
            <fieldset >
                ...
                <div class="box box-half" >
                    <label for="first_name">
                        <span> <?php esc_html_e('First name', 'squalomail-for-woocommerce'); ?></span>
                    </label>
                ...
                <div class="box box-half" >                    
                    <label for="last_name">
                        <span> <?php esc_html_e('Last name', 'squalomail-for-woocommerce'); ?></span>
                    </label>
                ...
                <div class="box" >
                    <label for="subject">
                        <span> <?php esc_html_e('Subject', 'squalomail-for-woocommerce'); ?></span>
                    </label>
                ...
                <div class="box" >
                    <label for="message">
                        <span> <?php esc_html_e('Message', 'squalomail-for-woocommerce'); ?></span>
                    </label>
                    <textarea required id="message" name="message"></textarea>
                </div>
                
                <div class="box">
                    <a id="sqm-mc-woocommerce-support-form-submit" class="button button-primary whitebtn tab-content-submit"><?php esc_html_e('Send', 'squalomail-for-woocommerce'); ?></a>
                ...
                <div class="box sqm-mc-woocommerce-create-account-step-error alignright" >
                    ...
                    <p id ="first_name_error"><?= esc_html__( 'Invalid First Name. Please double check.', 'squalomail-for-woocommerce' ); ?></p>
                    <p id ="last_name_error"><?= esc_html__( 'Invalid Last Name. Please double check.', 'squalomail-for-woocommerce' ); ?></p>
                    <p id ="subject_error"><?= esc_html__( 'Invalid Subject. Please double check.', 'squalomail-for-woocommerce' ); ?></p>
                    <p id ="message_error"><?= esc_html__( 'Invalid Message. Please double check.', 'squalomail-for-woocommerce' ); ?></p>
                    <p id ="success"><?= esc_html__( 'Message sent...', 'squalomail-for-woocommerce' ); ?></p>
                    <p id ="error"><?= esc_html__( 'Error: Message not sent...', 'squalomail-for-woocommerce' ); ?></p>
                </div>
