...
<fieldset>
    ...
    <div class="box box-half">
        <p>
            ...
            With standard logging, you can see basic information about the data submission to SqualoMail including any errors.
    ...
    <div class="box log-file-actions">
        ...
        <div id="log-actions">
            <?php if ( ! empty( $handle ) ) : ?>
                ...
                <a class="sqm-mc-woocommerce-log-button delete-log-button" title="<?= __('Delete Log', 'squalomail-for-woocommerce');?>" href="<?php echo esc_url( wp_nonce_url( add_query_arg( array( 'handle' => sanitize_title($viewed_log) ), admin_url( 'admin.php?page=squalomail-woocommerce&tab=logs&sqm_action=remove_log' ) ), 'remove_log' ) ); ?>">
