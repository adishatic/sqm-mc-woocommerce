 ...
 * Time: 2:17 PM
 */
class SqualoMail_WooCommerce_Product
{
    protected $id;
    protected $title;
    ...
    /**
     * @param SqualoMail_WooCommerce_ProductVariation $variation
     * @return SqualoMail_WooCommerce_Product
     */
    public function addVariant(SqualoMail_WooCommerce_ProductVariation $variation)
    {
